...
public final class SigningRouteDtos {
    ...
    public record SubmitSignatureRequest(
        ...
        public SubmitSignatureRequest(Long documentId, Long versionId, Long assignmentId, String cms,
                                      String clientRequestId, String privateKey, String password, String pkcs12) {
            this(documentId, versionId, assignmentId, cms, clientRequestId, null,
                    privateKey, password, pkcs12);
        }
    }
    ...
    public record SendForSigningRequest(Long expectedVersion) {
    }
    ...
    /** POST /api/public/document-flow/signing/{token}/sign body (module spec §13) - deliberately
     *  has no documentId/versionId/assignmentId: the token alone determines all three server-side
     *  (see PublicSigningService#signByToken). */
