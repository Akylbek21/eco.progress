...
public class ValidationException extends RuntimeException {
    ...
    /** Explicit top-level code regardless of how many field errors there are - use this when a
     *  module wants a single unified code (e.g. "VALIDATION_ERROR" always) rather than the
     *  single-field-error shortcut above. */
    public ValidationException(String message, String code, List<ApiFieldError> details) {
        super(message);
        this.code = code;
        this.details = details;
        this.fieldErrors = toFieldErrorMap(details);
