...
public class User {
    ...
    /** Staff member's own IIN (distinct from {@code bin}, which is the company's BIN) - used by
     *  kz.eco.signaturedoc's signing flow to compare against the IIN embedded in a submitted CMS
     *  signature's certificate (CERTIFICATE_OWNER_MISMATCH / CERTIFICATE_PROFILE_NOT_LINKED). */
    @Column(length = 20)
    private String iin;
    ...
    public void setAuthTokenVersion(long authTokenVersion) { this.authTokenVersion = authTokenVersion; }
}
