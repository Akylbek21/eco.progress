...
public final class ProtocolResultValuesMapper {
    ...
    private static final Set<String> KNOWN_VALUE_KEYS = Set.of(
            "samplingPointId", "samplingDate", "sampleDate", "samplingPlace", "samplingPoint", "point", "location",
            ...
            "conditionJson", "avgValue", "avg", "duration", "durationMinutes"
    );
    ...
    public static Map<String, Object> toValues(String templateCode, ProtocolResult result) {
        ...
        put(values, "samplingPointId", result.getSamplingPointId());
        ...
        put(values, "testingMethodNd", result.getTestingMethodNd());
        ...
        put(values, "avgValue", result.getAvgValue());
        put(values, "casNumber", result.getCasNumber());
        put(values, "cas", result.getCasNumber());
        put(values, "formula", result.getFormula());
        put(values, "normativeDocument", result.getNormativeDocument());
        put(values, "durationMinutes", result.getDurationMinutes());
        put(values, "duration", result.getDurationMinutes());
    ...
    static void applyValues(String templateCode, ProtocolResult result, Map<String, Object> values) {
        ...
        result.setSamplingPointId(readLong(values.get("samplingPointId")));
        ...
        result.setTestingMethodNd(readString(first(values, "testingMethodDocument", "testingMethod", "method", "testingMethodNd")));
        ...
        result.setAvgValue(readDecimal(first(values, "avgValue", "avg")));
        result.setCasNumber(readString(first(values, "casNumber", "cas")));
        result.setFormula(readString(first(values, "formula")));
        result.setNormativeDocument(readString(first(values, "normativeDocument")));
        String durationStr = readString(first(values, "durationMinutes", "duration"));
        if (durationStr != null) {
            try {
                result.setDurationMinutes((int) Math.round(Double.parseDouble(durationStr.replace(',', '.'))));
