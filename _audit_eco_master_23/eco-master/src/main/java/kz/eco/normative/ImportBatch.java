...
public class ImportBatch {
    ...
    /** SHA-256 файла, по которому строился preview: confirm принимает только тот же файл. */
    @Column(length = 64)
    ...
    public Long getRolledBackBy() { return rolledBackBy; }
    public void setRolledBackBy(Long rolledBackBy) { this.rolledBackBy = rolledBackBy; }
