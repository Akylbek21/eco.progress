...
class ProtocolTypeRegistryTest {
    ...
    @Test
    void allNineTypes_resolveByCanonicalId() {
    ...
    void legacyAliases_resolveToNewCanonicalIds() {
        ...
        assertEquals("ambient_air_szz", ProtocolTypeRegistry.require("ambient_air").templateId());
    }
    ...
    @Test
    void findSupportsAndFindActive_exposeTheSameNineTypes() {
        ...
        assertEquals(9, active.size(), "all 9 registered types have a real docx template on the classpath");
