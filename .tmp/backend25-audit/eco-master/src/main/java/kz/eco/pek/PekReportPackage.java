...
public class PekReportPackage {
    ...
    /** LONGTEXT pinned for the same reason as PekReportDocumentVersion.snapshotJson: left to @Lob,
     *  ddl-auto created TINYTEXT (255 bytes) on production and package generation could not save. */
    @Lob
    @Column(name = "snapshot_json", nullable = false, columnDefinition = "LONGTEXT")
    private String snapshotJson;

    @Lob
    @Column(name = "missing_fields_json", nullable = false, columnDefinition = "LONGTEXT")
