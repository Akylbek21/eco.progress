...
public class PekProgramMeasure {
    ...
    /** Объём работ as the program states it ("замена 2 фильтров", "1,5 га озеленения"). Free
     *  text: the unit varies per measure and the report prints it verbatim. */
    @Column(name = "work_volume", length = 1000)
    private String workVolume;

    /** Ожидаемый экологический эффект (e.g. "снижение выбросов пыли на 0,8 т/год"). */
    @Column(name = "environmental_effect", length = 2000)
    private String environmentalEffect;

    public String getWorkVolume() { return workVolume; }
    public void setWorkVolume(String v) { workVolume = v; }
    public String getEnvironmentalEffect() { return environmentalEffect; }
    public void setEnvironmentalEffect(String v) { environmentalEffect = v; }
