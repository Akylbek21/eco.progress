...
public final class SecurityExpressions {
    ...
    /* Матрица доступа раздела «Нормативы»:
     *   ADMIN, DIRECTOR - всё (просмотр, создание, изменение, архив/восстановление, импорт, rollback);
     *   HEAD            - просмотр, создание, изменение, импорт (preview/confirm/статус);
     *   LABORATORY      - только просмотр (подбор нормативов в журналах и протоколах);
     *   MANAGER         - только просмотр. */

    /** Просмотр/поиск справочника нормативов. */
    public static final String NORMATIVE_VIEW = "hasAnyRole('ADMIN','DIRECTOR','HEAD','LABORATORY','MANAGER')";
    /** Создание и редактирование норматива. */
    public static final String NORMATIVE_EDIT = "hasAnyRole('ADMIN','DIRECTOR','HEAD')";
    /** Архивирование (soft-delete), массовое архивирование и восстановление - без HEAD. */
    public static final String NORMATIVE_ARCHIVE = "hasAnyRole('ADMIN','DIRECTOR')";
    /** @deprecated исторический алиас - используйте NORMATIVE_EDIT / NORMATIVE_ARCHIVE. */
    @Deprecated
    public static final String NORMATIVE_MANAGE = NORMATIVE_ARCHIVE;
    /** Импорт нормативов: preview, confirm, статус импорта. */
    public static final String NORMATIVE_IMPORT = "hasAnyRole('ADMIN','DIRECTOR','HEAD')";
    /** Откат подтверждённого импорта - без HEAD. */
    public static final String NORMATIVE_IMPORT_ROLLBACK = "hasAnyRole('ADMIN','DIRECTOR')";
