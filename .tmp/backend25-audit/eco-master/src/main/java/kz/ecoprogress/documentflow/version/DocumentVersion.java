...
public class DocumentVersion {
    ...
    // Module spec §16/§26: storageKey must never leak to a client - DocumentController still
    // returns this entity directly from several endpoints (uploadFile/createVersion/listVersions/
    // getVersion), so the safest fix that touches nothing else about those responses is to keep
    // every other field exactly as the frontend already sees it and just stop serializing this one.
