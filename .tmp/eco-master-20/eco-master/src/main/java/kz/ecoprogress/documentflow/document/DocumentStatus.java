...
public enum DocumentStatus {
    ...
    /** Legacy value retained for rows created before PREPARED_FOR_SIGNING became canonical. */
    READY_FOR_SIGNING,
    SENT_FOR_SIGNING,
    PARTIALLY_SIGNED,
    SIGNED,
    ...
    private static final Map<DocumentStatus, Set<DocumentStatus>> ALLOWED_TRANSITIONS = Map.ofEntries(
            ...
            Map.entry(DRAFT, Set.of(PREPARED_FOR_SIGNING, READY_FOR_SIGNING, CANCELLED, ARCHIVED)),
            Map.entry(PREPARED_FOR_SIGNING, Set.of(SENT_FOR_SIGNING, DRAFT, CANCELLED)),
