...
export const pekKeys = {
  ...
  programReadiness: (id: string | number, userId?: PekUserScope, contentRevision?: string | number | null) => ['pek', userScope(userId), 'program-readiness', String(id), contentRevision ?? 'current'] as const,
  programMonitoring: (id: string | number, userId?: PekUserScope, contentRevision?: string | number | null) => ['pek', userScope(userId), 'program-monitoring', String(id), contentRevision ?? 'current'] as const,
  ...
  assigneesRoot: (companyId: string | number, userId?: PekUserScope) => ['pek', userScope(userId), 'lookups', 'assignees', companyScope(companyId)] as const,
  assignees: (companyId: string | number, roles: string[] = [], userId?: PekUserScope) => [...pekKeys.assigneesRoot(companyId, userId), roles] as const,
