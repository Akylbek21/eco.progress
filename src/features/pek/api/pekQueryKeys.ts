...
export const pekKeys = {
  ...
  reportReadiness: (id: string | number) => ['pek', 'report', String(id), 'readiness'] as const,
  reportCollection: (id: string | number) => ['pek', 'report', String(id), 'collection'] as const,
  reportPlanFact: (id: string | number) => ['pek', 'report', String(id), 'plan-fact'] as const,
  reportUnmatched: (id: string | number) => ['pek', 'report', String(id), 'unmatched-sources'] as const,
  reportHistory: (id: string | number) => ['pek', 'report', String(id), 'history'] as const,
