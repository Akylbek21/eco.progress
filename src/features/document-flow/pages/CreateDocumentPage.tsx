...
import {
  Alert, Box, Button, Collapse, FormControl, InputLabel, LinearProgress,
    ...
    <Stack spacing={3} maxWidth={1000} mx="auto">
      ...
      <Paper sx={{ p: { xs: 2, md: 4 } }}>
        ...
        {step === 1 && <Stack spacing={3}>
          ...
          <><Button variant="text" onClick={() => setAdvanced((value) => !value)}>Настройки маршрута подписания</Button><Collapse in={advanced}><SigningRouteBuilder access={access} organizationId={access.organization?.id} value={route} onChange={setRoute} /></Collapse></>
