...
const ProtocolDetailsView = ({ protocol, role, permissions, missing, workflowErrors, busy, signing, onBack, onEdit, onReady, onApprove, onReturn, onSign, onPublish, onGenerate, onDocx, onPdf, onCorrection, onCancel, onArchive, onReplacement }: Props) => {
  ...
  return (
    <div className="space-y-4 pb-24">
      ...
      {activeTab === 'documents' && <ProtocolDocumentsTab protocol={protocol} busy={busy} canGenerate={permissions.canGenerate} canDownload={permissions.canDownload} canSign={permissions.canSign} onGenerate={onGenerate} onDocx={onDocx} onPdf={onPdf} onSign={onSign} />}
