...
const ProtocolNextStepCard = ({ protocol, missing }: Props) => {
  ...
  if (['READY_FOR_APPROVAL', 'APPROVED'].includes(status)) { title = 'Протокол готов к следующему этапу'; text = 'Доступное действие определено backend и показано в карточке протокола.'; }
