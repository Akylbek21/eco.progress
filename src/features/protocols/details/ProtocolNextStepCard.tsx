...
const ProtocolNextStepCard = ({ protocol, missing }: Props) => {
  ...
  if (status === 'SIGNED') {
    title = protocol.publishedAt ? 'Опубликован' : 'Подписан / завершён';
    text = protocol.publishedAt
      ? 'Подписанный протокол опубликован и доступен клиенту.'
      : 'Сохранённый подписанный документ готов к просмотру и скачиванию.';
  }
