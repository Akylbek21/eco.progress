    ...
    <section>
      ...
      <div className="mt-5 grid gap-4 md:grid-cols-2">
        <label className="text-sm font-bold">Лаборатория *
          ...
          {errors.laboratoryId?.message && <span className="mt-1 block text-xs text-rose-700">{errors.laboratoryId.message}</span>}
        </label>
        <label className="text-sm font-bold">Исполнитель *
          ...
          {errors.executorId?.message && <span className="mt-1 block text-xs text-rose-700">{errors.executorId.message}</span>}
        </label>
