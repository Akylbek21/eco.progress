...
export const PROTOCOL_TEMPLATES: Record<ProtocolTemplateId, ProtocolTemplateConfig> = {
  ...
  water: { id: 'water', label: 'Вода / сточные воды', requiresSample: true, requiresEnvironment: true, requiresMeasurementPlace: true, requiresDevice: true, resultColumns: ['sampleNumber', 'samplingPlace', 'indicator', 'unit', 'normative', 'result', 'measurementDeviceId'] },
