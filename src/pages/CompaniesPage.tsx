...
const CompanyObjectsSection = ({ companyId, companyArchived }: { companyId: string; companyArchived: boolean }) => {
  ...
  const objectsQuery = useQuery({ queryKey: ['company-objects', companyId, companyArchived], queryFn: ({ signal }) => getCompanyObjects(companyId, companyArchived, signal) });
