...
const processSteps = [
  {
    ...
    text: 'Опишите задачу или выберите услугу, даже если не знаете точный термин.',
  },
  {
    title: 'Специалист уточняет детали',
    text: 'Мы задаем короткие вопросы и объясняем, какие данные понадобятся.',
  },
  {
    title: 'Готовим расчет и договор',
    text: 'Вы заранее видите порядок работ, сроки и условия.',
  },
  {
    title: 'Выполняем работу',
    text: 'Готовим документы, организуем анализы, вывоз отходов или сопровождение.',
  },
  {
    title: 'Вы получаете результат',
    text: 'Статусы, документы и комментарии доступны в личном кабинете.',
  },
];
