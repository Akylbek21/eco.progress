...
const NotFoundPage = () => (
  <section className="flex min-h-[70vh] items-center bg-[#F7FBFD] px-4 py-16 sm:px-8">
    <SEO title="Страница не найдена | ECOPROGRESS GROUP" description="Страница не найдена. Перейдите на главную или оставьте заявку на экологические услуги." />
    <div className="mx-auto max-w-2xl text-center">
      ...
      <div className="mt-8 grid gap-3 sm:flex sm:justify-center">
        ...
        <Link to="/cabinet/orders/new"><Button variant="secondary">Оставить заявку</Button></Link>
      </div>
    </div>
  </section>
);
