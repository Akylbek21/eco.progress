...
const PekPermitsPage = lazy(() => import('./features/pek/pages/PekPermitsPage'));
  ...
  return (
    <RouteProgressProvider>
      <div className="min-h-screen bg-eco-50 text-slate-900">
        ...
        <Route path="/staff/companies" element={<RoleAccess roles={allStaffRoles} loginPath="/staff/login"><StaffLayout><CompanyPermissionAccess permission="COMPANY_VIEW"><ErrorBoundary fallbackTitle="Не удалось открыть компании"><CompaniesPage /></ErrorBoundary></CompanyPermissionAccess></StaffLayout></RoleAccess>} />
        <Route path="/staff/companies/new" element={<RoleAccess roles={allStaffRoles} loginPath="/staff/login"><StaffLayout><CompanyPermissionAccess permission="COMPANY_CREATE"><ErrorBoundary fallbackTitle="Не удалось открыть создание компании"><CompaniesPage /></ErrorBoundary></CompanyPermissionAccess></StaffLayout></RoleAccess>} />
        <Route path="/staff/companies/:companyId" element={<RoleAccess roles={allStaffRoles} loginPath="/staff/login"><StaffLayout><CompanyPermissionAccess permission="COMPANY_VIEW"><ErrorBoundary fallbackTitle="Не удалось открыть компанию"><CompaniesPage /></ErrorBoundary></CompanyPermissionAccess></StaffLayout></RoleAccess>} />
        <Route path="/staff/companies/:companyId/edit" element={<RoleAccess roles={allStaffRoles} loginPath="/staff/login"><StaffLayout><CompanyPermissionAccess permission="COMPANY_EDIT"><ErrorBoundary fallbackTitle="Не удалось открыть редактирование компании"><CompaniesPage /></ErrorBoundary></CompanyPermissionAccess></StaffLayout></RoleAccess>} />
        ...
        <Route path="/staff/pek/permits" element={<RoleAccess roles={pekRoles} loginPath="/staff/login"><StaffLayout><PekAccess><ErrorBoundary fallbackTitle="Не удалось открыть разрешительные документы"><PekPermitsPage /></ErrorBoundary></PekAccess></StaffLayout></RoleAccess>} />
