  ...
  return (
    <RouteProgressProvider>
      <div className="min-h-screen bg-eco-50 text-slate-900">
        ...
        <Route path="/staff/pek/reports/:reportId/workspace" element={<RoleAccess roles={pekRoles} loginPath="/staff/login"><StaffLayout><PekAccess><ErrorBoundary fallbackTitle="Не удалось открыть рабочую область отчёта ПЭК"><PekReportWorkspacePage /></ErrorBoundary></PekAccess></StaffLayout></RoleAccess>} />
        ...
        <Route path="/staff/pek/settings" element={<RoleAccess roles={pekRoles} loginPath="/staff/login"><StaffLayout><PekSettingsAccess><PekPermissionAccess permission="PEK_ADMIN"><ErrorBoundary fallbackTitle="Не удалось открыть настройки ПЭК"><PekSettingsPage /></ErrorBoundary></PekPermissionAccess></PekSettingsAccess></StaffLayout></RoleAccess>} />
