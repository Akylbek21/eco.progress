...
export const normalizeCompany = (raw: unknown): CompanyDetails => {
  ...
  return {
    ...
    directorName: pick(source, ['directorName', 'directorFullName', 'director', 'headName']),
    director: pick(source, ['director', 'directorName', 'directorFullName', 'headName']),
    directorPosition: pick(source, ['directorPosition', 'headPosition']),
    responsiblePerson: pick(source, ['responsiblePerson', 'contactPerson']),
    responsiblePersonPhone: pick(source, ['responsiblePersonPhone', 'contactPhone', 'responsiblePhone']),
