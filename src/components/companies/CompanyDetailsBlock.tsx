...
const CompanyDetailsBlock = ({ company, compact = false }: { company: CompanyDetails; compact?: boolean }) => {
  const mainRows: Array<[string, string | undefined]> = [
    ...
    ['Руководитель', company.directorName], ['Контактное лицо', company.responsiblePerson],
    ['Телефон контактного лица', company.responsiblePersonPhone], ['Email контактного лица', company.contactEmail],
  ];
