...
const NewsCard = ({ item }: { item: NewsItem }) => {
  return (
    <article className="overflow-hidden rounded-[28px] border border-slate-200 bg-white shadow-sm transition hover:-translate-y-1 hover:shadow-2xl">
      <ResponsiveImage sizes="(max-width: 767px) 100vw, 33vw" src={item.image} alt={item.title} width={900} height={506} wrapperClassName="aspect-[16/9] w-full" className="object-cover" />
      <div className="p-6">
