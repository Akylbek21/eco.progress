...
export const TrustSection = () => <section id="trust" className="bg-white px-4 py-16 sm:px-8 sm:py-20"><div className="mx-auto max-w-7xl"><div className="max-w-3xl"><p className="text-sm font-semibold uppercase tracking-[0.2em] text-eco-500">Доверие</p><h2 className="mt-3 text-3xl font-bold text-eco-900 sm:text-4xl">Почему предприятия выбирают EcoProgress</h2><p className="mt-4 leading-7 text-slate-600">Объединяем экологическое проектирование, лабораторные исследования и сопровождение предприятия до согласованного результата.</p></div><div className="mt-10 grid gap-4 md:grid-cols-2 xl:grid-cols-4">{reasons.map(([title, Icon]) => <div key={title} className="rounded-[20px] border border-slate-200 bg-[#F7FBFD] p-5 shadow-sm"><Icon className="text-eco-600" size={24} /><p className="mt-4 text-sm font-bold leading-6 text-eco-900">{title}</p></div>)}</div></div></section>;
