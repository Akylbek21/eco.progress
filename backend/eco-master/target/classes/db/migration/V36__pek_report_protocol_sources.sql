...
CREATE TABLE IF NOT EXISTS pek_report_protocol_sources (
    ...
    -- `manual` is a RESERVED word from MySQL 8.4 on, so the identifier must stay quoted here too;
    -- without the backticks this CREATE TABLE is a syntax error on a fresh 8.4 database.
