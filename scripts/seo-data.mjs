...
const legacyStaticPages = [
  ...
  { path: '/experts', title: 'Эксперты ECOPROGRESS', description: 'Подтверждённые специалисты ECOPROGRESS и сведения об их обучении и профессиональных компетенциях.', h1: 'Эксперты ECOPROGRESS', priority: 0.7, changefreq: 'monthly', type: 'expert-list' },
