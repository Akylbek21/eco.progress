...
const cityLinks = (city) => {
  ...
  return [
    ...
    link('Эколог на аутсорсинге', '/services/ecological-support'),
...
const legacyStaticPages = [
  ...
  { path: '/services/ecological-support', title: 'Эколог на аутсорсинге в Казахстане | Экологическое сопровождение предприятий | ECOPROGRESS', description: 'Комплексное экологическое сопровождение предприятий по Казахстану: ПЭК, экологическая отчетность, отходы, разрешения, лабораторный контроль, проверки и экологические риски. Абонентское сопровождение ECOPROGRESS.', h1: 'Эколог на аутсорсинге — комплексное экологическое сопровождение предприятия', priority: 0.9, changefreq: 'weekly', type: 'service' },
  { path: '/pek-system', title: 'Цифровая система ПЭК для предприятий | EcoProgress', description: 'Программа ПЭК, отчёты, лабораторные протоколы, сроки и экологические документы в одном цифровом кабинете EcoProgress.', h1: 'Цифровой кабинет ПЭК для предприятий', priority: 0.8, changefreq: 'monthly', type: 'main' },
  ...
  { path: '/reviews', title: 'Отзывы клиентов | ECOPROGRESS', description: 'Проверенные отзывы клиентов EcoProgress об экологических услугах, документах, лабораторных работах и сопровождении.', h1: 'Отзывы клиентов EcoProgress', priority: 0.5, changefreq: 'monthly', type: 'main' },
  { path: '/licenses', title: 'Лицензии и документы | ECOPROGRESS', description: 'Проверяемые лицензии, разрешения, сертификаты и сведения о компетенциях EcoProgress.', h1: 'Лицензии, разрешения и сертификаты', priority: 0.7, changefreq: 'monthly', type: 'main' },
  { path: '/calculator', title: 'Предварительный расчёт экологических услуг | ECOPROGRESS', description: 'Предварительный подбор состава экологических услуг по задаче, категории объекта и региону.', h1: 'Подберите состав экологических услуг', priority: 0.7, changefreq: 'monthly', type: 'service' },
  { path: '/checklists', title: 'Экологические чек-листы для предприятий | ECOPROGRESS', description: 'Практические экологические чек-листы для подготовки документов, проверок, ПЭК, лаборатории и работы с отходами.', h1: 'Чек-листы для предприятий', priority: 0.6, changefreq: 'monthly', type: 'main' },
  { path: '/industries', title: 'Экологические решения по отраслям | ECOPROGRESS', description: 'Экологические решения EcoProgress для промышленности, строительства, медицины, логистики, торговли и корпоративных объектов.', h1: 'Экологические решения для разных отраслей', priority: 0.7, changefreq: 'monthly', type: 'main' },
  { path: '/deadlines', title: 'Календарь экологических сроков | ECOPROGRESS', description: 'Календарь экологической отчётности и обязательных мероприятий для предприятий Казахстана.', h1: 'Календарь экологической отчётности', priority: 0.6, changefreq: 'monthly', type: 'main' },
