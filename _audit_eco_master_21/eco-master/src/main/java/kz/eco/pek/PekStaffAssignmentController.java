...
// Module spec item 9: granting another user access to a client company's PEK data is an
// administrative act, so it is ADMIN/DIRECTOR only (PEK_ADMIN). It used to be PEK_SETTINGS_EDIT,
// which also includes HEAD - a HEAD could therefore widen company access, including their own.
