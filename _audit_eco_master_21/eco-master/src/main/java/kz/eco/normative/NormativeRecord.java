...
public class NormativeRecord {
    ...
    /** Пользователь, создавший запись (null - системный сидер / исторические данные). */
    private Long createdBy;

    /** Пользователь, последним изменивший запись (включая архивирование/восстановление/rollback). */
    private Long updatedBy;

    /** Предыдущая версия, которую эта запись заменила при импорте (её деактивировали). Нужна
     *  rollback'у, чтобы вернуть заменённую версию, а не просто погасить новую. */
    private Long replacedRecordId;
    ...
    public Long getReplacedRecordId() { return replacedRecordId; }
    public void setReplacedRecordId(Long replacedRecordId) { this.replacedRecordId = replacedRecordId; }
